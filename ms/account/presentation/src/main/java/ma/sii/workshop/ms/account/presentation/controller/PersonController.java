package ma.sii.workshop.ms.account.presentation.controller;

import lombok.RequiredArgsConstructor;
import ma.sii.workshop.libs.response.Response;
import ma.sii.workshop.libs.response.ResponseAPI;
import ma.sii.workshop.ms.account.domain.entity.Person;
import ma.sii.workshop.ms.account.domain.service.PersonService;
import ma.sii.workshop.ms.account.presentation.dto.PersonDTO;
import ma.sii.workshop.ms.account.presentation.mapping.PersonMapper;
